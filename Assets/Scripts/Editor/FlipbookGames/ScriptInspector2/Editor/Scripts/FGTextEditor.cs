...
//	private float contentWidth = 0;
	...
	public static T LoadEditorResource<T>(string indieName, string proName = null) where T : UnityEngine.Object
	{
	...
	public static EditorWindow GetFocusedInspector()
	{
		...
		{
			System.Reflection.FieldInfo fi = wndType.GetField("s_CurrentInspectorWindow", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
			if (fi != null)
			{
	...
	public void OnWindowGUI(EditorWindow window, bool isTextInspector = false)
	{
		...
		if (textBuffer != null)
		{
			Rect rc = new Rect(Screen.width - 22f, scrollViewRect.yMin - 17f, 18f, 16f);
	...
	public void OnInspectorGUI(bool isTextInspector)
	{
		if (isTextInspector)
		{
			OnWindowGUI(GetFocusedInspector(), true);
			return;
		}
...
//			column = rowLength;
	...
	{
		if (textBuffer.isText && EditorWindow.focusedWindow.GetType() != typeof(FGCodeWindow))
