...
public sealed class ObjectPool : MonoBehaviour
{
	...
	readonly Dictionary<Component, List<Component>> objectLookup = new Dictionary<Component, List<Component>>();
	readonly Dictionary<Component, Component> prefabLookup = new Dictionary<Component, Component>();
    ...
    return (T)Instantiate(prefab, position, prefab.transform.localRotation);
	}

	public static T Spawn<T>(T prefab, Vector3 position) where T : Component
	{
		return Spawn(prefab, position, prefab.transform.rotation);
	}
